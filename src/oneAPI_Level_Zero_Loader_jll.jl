module oneAPI_Level_Zero_Loader_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import oneAPI_Level_Zero_Loader_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("13eca655-d68d-5b81-8367-6d99d727ab01"))
platforms = [Pkg.Artifacts.unpack_platform(e, "oneAPI_Level_Zero_Loader", artifacts_toml) for e in artifacts["oneAPI_Level_Zero_Loader"]]
...
if best_platform === nothing
    @debug("Unable to load oneAPI_Level_Zero_Loader; unsupported platform $(triplet(platform_key_abi()))")
else
