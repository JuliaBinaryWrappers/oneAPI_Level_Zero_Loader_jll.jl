# `oneAPI_Level_Zero_Loader_jll.jl` (v1.16.11+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/38b235069c0e2cd8a42ee6d3d1e98a32faaf1017/O/oneAPI_Level_Zero/oneAPI_Level_Zero_Loader/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
