# `oneAPI_Level_Zero_Loader_jll.jl` (v1.8.12+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/b9e2599fdcb937d2ee456ce42f1c394c9ed1ed0d/O/oneAPI_Level_Zero/oneAPI_Level_Zero_Loader/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/oneapi-src/level-zero.git (revision: `23641699b9e2a68f61e6f12a61a27d1f1ef54570`)
